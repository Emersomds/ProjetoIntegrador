...
<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-4" style="background-color: #b5dbdf;border-radius: 10px 20px;">
				<h3>Login</h3>
				<form class="form-horizontal" action="login" method="post" name="formLogin">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-8">
							<input type="submit" class="btn btn-primary" value="Logar" onClick="validarLogin()"/>
						</div>
					</div>
				</form>
			</div>
			<div class="col-sm-4"><img id="ogo2"
					src="imagens/Marcos.svg" alt="logo" ></div></div>
		</div>
	</div>
<footer class="footer">
