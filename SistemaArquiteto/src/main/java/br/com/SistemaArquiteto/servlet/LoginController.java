package br.com.SistemaArquiteto.servlet;
...
import br.com.SistemaArquiteto.exception.InvalidUserException;
...
public class LoginController extends HttpServlet {
	...
	private void ValidaDadosRecebidos(HttpServletRequest req) throws ServletException {
		...
		String nomeSenha = req.getParameter("txtSenha");
		 ...
		 if(!nomeUsuario.trim().equals("Emy") || !nomeSenha.trim().equals("123"))
